...
class Triangulo {
    ...
    fun darPerimetro(): Double {
        var per= calcularLado1()+calcularLado2()+calcularLado3()
        return per
    }
     ...
     */
    fun centroide(): Punto {
        var operx= (this.punto1.darX()+this.punto2.darX()+this.punto3.darX())/3
        var opery= (this.punto1.darY()+this.punto2.darY()+this.punto3.darY())/3
        return Punto(operx, opery)
    }
